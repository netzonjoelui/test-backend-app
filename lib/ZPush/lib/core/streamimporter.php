...
class ImportChangesStream implements IImportChanges {
    ...
    public function ImportMessageChange($id, $message) {
        ...
        if ($message->flags === false || $message->flags === SYNC_NEWMESSAGE) {
            ...
            ZLog::Write(LOGLEVEL_DEBUG, "ImportChangesStream->ImportMessageChange($id): Adding tag for a new entity");
        } else {
            ...
            ZLog::Write(LOGLEVEL_DEBUG, "ImportChangesStream->ImportMessageChange($id): Adding tag for a modified entity");
